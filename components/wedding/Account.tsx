...
export default function AccountBtn(props: AccountBtnProps) {
    ...
    const copyGroomAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.groom_bank} ${accountInfo.groom_account} ${accountInfo.groom_bank_name}`
    ...
    const copyGroomFatherAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.groom_father_bank} ${accountInfo.groom_father_account} ${accountInfo.groom_father_bank_name}`
            copyToClipboard(text, "복사되었습니다")
        }
    }
    ...
    const copyGroomMotherAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.groom_mother_bank} ${accountInfo.groom_mother_account} ${accountInfo.groom_mother_bank_name}`
            copyToClipboard(text, "복사되었습니다")
        }
    }
    ...
    const copyBrideAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.bride_bank} ${accountInfo.bride_account} ${accountInfo.bride_bank_name}`
            copyToClipboard(text, "복사되었습니다")
        }
    }
    ...
    const copyBrideFatherAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.bride_father_bank} ${accountInfo.bride_father_account} ${accountInfo.bride_father_bank_name}`
            copyToClipboard(text, "복사되었습니다")
        }
    }
    ...
    const copyBrideMotherAccount = () => {
        if (accountInfo) {
            const text = `${accountInfo.bride_mother_bank} ${accountInfo.bride_mother_account} ${accountInfo.bride_mother_bank_name}`
            copyToClipboard(text, "복사되었습니다")
        }
    }
    ...
    return (
        ...
        >
            ...
            {/* 복사 메시지 - 컨테이너 기준 좌우 중앙, 뷰포트 기준 상하 중앙 */}
            <AnimatePresence>
                {showCopyMessage && (
                    <div
                        style={{
                                ...
                                if (acc.component === "groom") {
                                    return (
                                        <AccountItem
                                            key="groom"
                                            label="신랑"
                                            name={accountInfo.groom_bank_name}
                                    ...
                                    return (
                                        <AccountItem
                                            key="groom_father"
                                            label="혼주"
                                            name={accountInfo.groom_father_bank_name}
                                            account={
                                                accountInfo.groom_father_account
                                            }
                                    ...
                                    return (
                                        <AccountItem
                                            key="groom_mother"
                                            label="혼주"
                                            name={accountInfo.groom_mother_bank_name}
                                            account={
                                                accountInfo.groom_mother_account
                                            }
                                ...
                                if (acc.component === "bride") {
                                    return (
                                        <AccountItem
                                            key="bride"
                                            label="신부"
                                            name={accountInfo.bride_bank_name}
                                    ...
                                    return (
                                        <AccountItem
                                            key="bride_father"
                                            label="혼주"
                                            name={accountInfo.bride_father_bank_name}
                                            account={
                                                accountInfo.bride_father_account
                                            }
                                    ...
                                    return (
                                        <AccountItem
                                            key="bride_mother"
                                            label="혼주"
                                            name={accountInfo.bride_mother_bank_name}
                                            account={
                                                accountInfo.bride_mother_account
                                            }
